...
-- CreateEnum
CREATE TYPE "NotificationPref" AS ENUM ('ALL', 'MENTIONS', 'MUTED');

-- CreateEnum
CREATE TYPE "MessageKind" AS ENUM ('USER', 'SYSTEM', 'INTEGRATION');

-- CreateEnum
CREATE TYPE "MentionType" AS ENUM ('USER', 'CHANNEL', 'HERE');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MENTION', 'THREAD_REPLY', 'REACTION', 'DM', 'CHANNEL_MESSAGE', 'SYSTEM');
...
-- CreateTable
CREATE TABLE "AtlassianAccountLink" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "AtlassianAccountLink_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Conversation_workspaceId_memberKey_key" ON "Conversation"("workspaceId", "memberKey");
...
-- CreateIndex
CREATE UNIQUE INDEX "Message_userId_clientMsgId_key" ON "Message"("userId", "clientMsgId");
...
-- CreateIndex
CREATE UNIQUE INDEX "SavedItem_userId_messageId_key" ON "SavedItem"("userId", "messageId");

-- CreateIndex
CREATE INDEX "Mention_userId_idx" ON "Mention"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "Mention_messageId_userId_type_key" ON "Mention"("messageId", "userId", "type");
...
-- CreateIndex
CREATE UNIQUE INDEX "AtlassianAccountLink_userId_key" ON "AtlassianAccountLink"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "AtlassianAccountLink_atlassianAccountId_key" ON "AtlassianAccountLink"("atlassianAccountId");
...
-- AddForeignKey
ALTER TABLE "SavedItem" ADD CONSTRAINT "SavedItem_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AtlassianAccountLink" ADD CONSTRAINT "AtlassianAccountLink_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
